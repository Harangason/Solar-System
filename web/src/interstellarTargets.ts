...
export const INTERSTELLAR_TARGETS: InterstellarTarget[] = [
  { id: 'proxima-centauri', name: 'Proxima Centauri', distanceLy: 4.22, rightAscensionDeg: 217.43, declinationDeg: -62.68, spectralType: 'M5.5 V', kind: 'stellar-system', color: '#ff8a68' },
  ...
  { id: 'epsilon-eridani', name: 'Epsilon Eridani', distanceLy: 10.50, rightAscensionDeg: 53.23, declinationDeg: -9.46, spectralType: 'K2 V', kind: 'stellar-system', color: '#ffc477' },
